            ...
            <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
                  About Impact AI — Supporting Students, Saving Lives
                </h1>

                <p className="text-lg text-muted-foreground max-w-2xl">
                  Mental health crises among students are rising: increased anxiety, depression,
                  suicidal ideation, and barriers to timely care. Impact AI combines AI screening,
          ...
          <section className="py-16 px-4">
            <div className="container mx-auto">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="text-3xl font-bold mb-4">How Impact AI helps during a crisis</h2>
